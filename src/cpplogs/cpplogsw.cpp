...
namespace CppLogs {
	...
	Error::EnErrorCode CppLogsW::set_item_type(const StCppLogsItem& st_CppLogsItem)
	{
		_st_CppLogsItem = st_CppLogsItem;
		if (!ToolBox::existfile(_filename.data)) {
			return Error::ErrorCode_OpenFileFailed;
		}
		CppLogsW::StCppLogsItem st_CppLogsItemCurr = _analy_item();
	...
	CppLogsW::StCppLogsItem CppLogsW::_analy_item()
	{
		std::string data;
